...
# We have these measurements for same number of years we have solar 
...
-   Imagine that habitat suitability for parrot can be modeled with the following equations, where
...
Normalize inputs (precipitation and temperature) in order to make them comparable.
