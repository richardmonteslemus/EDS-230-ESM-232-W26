...
# Sample alot because we have too little data an therefore it is too variable
```
...
pnames <- c("Tmincoeff1", "Tmincoeff1", "Pcoeff1", "Pcoeff2", "intercept")
...
parm = as.data.frame(matrix(nrow = nrow(parm_quant), ncol =nol(parm_quant)))
...
parm[, "Pcoeff1"] = qnorm(parm_quant[, "Pcoeff2"], mean = )
...
value = ("parmvalue", key = "parm")
ggplot(tmp3, aes(parmvalue, yvalue, col))
