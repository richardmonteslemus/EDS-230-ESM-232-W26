...
```{r}
plot(resfast_fixtime$conc[,1], ylab = "Conc. at 1 spatial time units from origin (1+2)", xlab = "timestep")
```
...
# single column (time)
plot(resfast_fixtime$conc[5,], ylab = "Conc. at 5 spatial time units for all space chunks", xlab = "space")
...
cmean = resfast$conc %>% apply(1,mean)
