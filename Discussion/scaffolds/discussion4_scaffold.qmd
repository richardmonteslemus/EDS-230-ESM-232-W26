...
X = cbind.data.frame(Tmincoeff1, Tmincoeff2, Pcoeff1, Pcoeff2, intercep)
...
ggplot(both, aes(mean_annual_yields)) +
  geom_histogram() + 
...
```{r, alternative}
sens_almond_sobol_2 = sobolSalt(model = NULL, x1, x2, nboot = )
